...
def apply_H_inv(
    ...
    projected = np.linalg.inv(H) @ euclidian_to_homogeneous(points)
    projected = homogeneous_to_euclidian(projected)
    return projected
...
def test_img_3(fiducial_points: Dict, calibration: Dict) -> None:
    ...
    projected_norm = apply_H_with_denorm(H_tilda_norm, w_world, w_camera, world_points)
    ...
    back_projected_norm = apply_H_inv_with_denorm(H_tilda_norm, w_world, w_camera, camera_points)
